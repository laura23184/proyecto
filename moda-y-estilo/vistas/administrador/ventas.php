    ...
    <div class="dashboard">
        ...
        <div class="sidebar">
            ...
            <nav>
                    ...
                    <li class="active" data-section="Ventas">
                        <a href="ventas.php">
                            ...
                            <table>
                                ...
                                <tbody id="tabla-venta">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button onClick="verParaEditar('<?= $value['id'] ?>','<?= $value['codigo'] ?>','<?= $value['total'] ?>')" class="btn btn-warning"><i class="fas fa-pencil"></i></button> 
                                            <a href="../../controlador/ventas_c.php?accion=eliminar&id=<?= $value['id'] ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
    ...
    <div class="modal" id="addCategoryModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="" action="../../controlador/ventas_c.php?accion=crear" method="post">
                    <input type="hidden" id="id" name="id" >
                     ...
                     <div class="form-group">
                        <label for="categoryName">total</label>
...
<script>
    function verParaEditar(id, codigo, total) {
