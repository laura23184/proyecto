    ...
    <div class="dashboard">
        ...
        <div class="sidebar">
            ...
            <nav>
                    ...
                    <li class="active" data-section="inventario">
                            ...
                            <table>
                                ...
                                <tbody id="tabla-categorias">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button onClick="verParaEditar('<?= $value['id'] ?>','<?= $value['nombre'] ?>','<?= $value['codigo'] ?>','<?= $value['precio'] ?>','<?= $value['stock'] ?>','<?= $value['id_categoria'] ?>')" class="btn btn-warning"><i class="fas fa-pencil"></i></button> 
                                            <a href="../../controlador/inventario_c.php?accion=eliminar&id=<?= $value['id'] ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
    ...
    <div class="modal" id="addCategoryModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="" action="../../controlador/inventario_c.php?accion=crear" method="post">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="categoryName">codigo</label>
                        <input type="number" id="codigo" name="codigo" required>
                    </div>
                     <div class="form-group">
                        <label for="categoryName">precio</label>
                     ...
                     <div class="form-group">
                        <label for="categoryName">categorias</label>
...
<script>
    function verParaEditar(id, nombre, codigo, precio, stock, id_categoria) {
