...
<?php 
    ...
    $resultado =  obtenerClientes($conn);
 ?>
<body>
        ...
        <div class="sidebar">
            ...
            <nav>
                    ...
                    <li data-section="Ventas">
                     ...
                     <li class="active" data-section="clientes">
                        <a href="clientes.php">
                            ...
                            <table>
                                ...
                                <tbody id="tabla-clientes">
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $value['celular']; ?></td>
                                        <td>
                                            <button onClick="verParaEditar('<?= $value['id'] ?>','<?= $value['nombre'] ?>','<?= $value['celular'] ?>')" class="btn btn-warning"><i class="fas fa-pencil"></i></button> 
                                            <a href="../../controlador/clientes_c.php?accion=eliminar&id=<?= $value['id'] ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
    ...
    <div class="modal" id="addCategoryModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="" action="../../controlador/clientes_c.php?accion=crear" method="post">
                    <input type="hidden" id="id" name="id" >
                    <div class="form-group">
                        <label for="categoryName">Nombre del cliente</label>
...
<script>
    function verParaEditar(id, nombre, celular) {
